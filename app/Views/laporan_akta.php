    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Laporan Akta</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Lap.Akta</h5>

              <!-- Form pencarian berdasarkan tanggal -->
    <form action="<?= base_url('laporan_akta/search'); ?>" method="post">
...
<tr>
  ...
  <th scope="col">Total Biaya</th>
    ...
    <script>
    function printData() {
        window.location.href = "<?= base_url('laporan_akta/printAll'); ?>";
    }
</script>
